...
WebUI.click(findTestObject('Object Repository/Repository 2/Page_OrangeHRM/span_Username'))

TestDataFactory.findTestData("Data Files/LoginData").getAllData()
...
WebUI.click(findTestObject('Object Repository/Repository 2/Page_OrangeHRM/a_Welcome Admin'))

WebUI.click(findTestObject('Object Repository/Repository 2/Page_OrangeHRM/a_Logout'))
